-- ============================================================
-- Migration 018: Date-filtered % uses all rides in range
-- ============================================================
-- When a date range is active, total_distance_meters and
-- total_elevation_meters should include ALL rides within that
-- range (not filtered by active SF2G years). The "active years"
-- logic only applies to the all-time materialized view.
...
BEGIN
  ...
  SELECT
    ...
    -- Date-filtered: total = ALL rides in the range (date range is the scope)
