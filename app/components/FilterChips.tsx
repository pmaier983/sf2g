        ...
        >
          ...
          >
            <span
              ...
              onKeyDown={(e) =>
                handleKeyDown(e, () => onWeekendsChange(!weekendsActive))
              }
            >
              <span className="filter-chip__emoji" aria-hidden="true">
                📅
          ...
          >
            <span
              ...
              onKeyDown={(e) =>
                handleKeyDown(e, () => onReverseChange(!reverseActive))
              }
            >
              <span className="filter-chip__emoji" aria-hidden="true">
                🔄
          ...
          >
            <span
              ...
              onKeyDown={(e) =>
                handleKeyDown(e, () => onOtherChange(!includeOther))
              }
            >
              Other
              <span className="filter-chip__info-icon" aria-hidden="true">
                ⓘ
              </span>
            </span>
          </Tooltip>
