...
export const leaderboardColumns = [
  columnHelper.display({
    id: "rank",
    header: () => (
      <HeaderWithTooltip label="#" tooltip="Rank by total SF2G commute rides" />
    ),
    cell: (info) => (
  ...
  columnHelper.accessor("display_name", {
    header: () => (
      <HeaderWithTooltip
        label="Rider"
        tooltip="Rider name (click to view profile)"
      />
    ),
    cell: (info) => {
  ...
  columnHelper.accessor("sf2g_total", {
    header: () => (
      <HeaderWithTooltip
        label="SF2G"
        tooltip="Total SF2G commute rides (click to view rides)"
      />
    ),
    cell: (info) => (
      <button
  ...
  columnHelper.accessor("active_years", {
    header: () => (
      <HeaderWithTooltip
        label="Yrs"
        tooltip="Calendar years with at least 1 SF2G commute"
      />
    ),
    cell: ({ getValue }) => {
  ...
  columnHelper.accessor("avg_speed_mps", {
    header: () => (
      <HeaderWithTooltip
        label="Avg Speed"
        tooltip="Average speed across all SF2G commutes"
      />
    ),
    cell: (info) => {
      return (
  ...
  columnHelper.accessor("avg_heartrate", {
    header: () => (
      <HeaderWithTooltip
        label="Avg HR"
        tooltip="Average heart rate across SF2G rides (HR monitor required)"
      />
    ),
    cell: (info) => {
      const val = info.getValue();
  ...
  columnHelper.accessor("avg_kilojoules", {
    header: () => (
      <HeaderWithTooltip
        label="Avg Cal"
        tooltip="Average calories (kilojoules) per SF2G ride"
      />
    ),
    cell: (info) => {
      const val = info.getValue();
  ...
  columnHelper.accessor("bayway_count", {
    header: () => (
      <HeaderWithTooltip
        label="Bayway"
        tooltip="Bayway route rides — flat route via the bay trail (~40 mi). Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("skyline_count", {
    header: () => (
      <HeaderWithTooltip
        label="Skyline"
        tooltip="Skyline route rides — hilly route via CA-35 (~45 mi). Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("hmbw_count", {
    header: () => (
      <HeaderWithTooltip
        label="HMBW"
        tooltip="Half Moon Bay Way rides — coastal scenic route (~50 mi). Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("royale_count", {
    header: () => (
      <HeaderWithTooltip
        label="Royale"
        tooltip="Royale route rides — Skyline + HMBW combined (~55 mi). Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("fleaway_count", {
    header: () => (
      <HeaderWithTooltip
        label="Fleaway"
        tooltip="Fleaway route rides — flat El Camino/Bayshore blend. Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("mebw_count", {
    header: () => (
      <HeaderWithTooltip
        label="MEBW"
        tooltip="Middle East Bay Way rides — through Castro Valley and Fremont. Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("febw_count", {
    header: () => (
      <HeaderWithTooltip
        label="FEBW"
        tooltip="Far East Bay Way rides — through Berkeley Hills, Orinda, Dublin. Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor("other_count", {
    header: () => (
      <HeaderWithTooltip
        label="Other"
        tooltip="Unclassified or alternate route rides. Click to see rides."
      />
    ),
    cell: (info) =>
      routeCountCell(
  ...
  columnHelper.accessor(
    ...
    },
    {
      ...
      header: () => (
        <HeaderWithTooltip
          label="% Dist"
          tooltip="SF2G commute distance as a percentage of total cycling distance"
        />
      ),
      cell: (info) => (
        <TinyPie
          sf2gValue={info.row.original.sf2g_distance_meters ?? 0}
          totalValue={info.row.original.total_distance_meters ?? 0}
          kind="distance"
        />
      ),
      size: 72,
  ...
  columnHelper.accessor(
    ...
    },
    {
      ...
      header: () => (
        <HeaderWithTooltip
          label="% Elev"
          tooltip="SF2G commute elevation as a percentage of total cycling elevation"
        />
      ),
      cell: (info) => (
        <TinyPie
          sf2gValue={info.row.original.sf2g_elevation_meters ?? 0}
          totalValue={info.row.original.total_elevation_meters ?? 0}
          kind="elevation"
        />
      ),
      size: 72,
  ...
  columnHelper.accessor("sf2g_distance_meters", {
    header: () => (
      <HeaderWithTooltip
        label="SF2G Dist"
        tooltip="Total distance from SF2G commute rides only"
      />
    ),
    cell: (info) => {
  ...
  columnHelper.accessor("sf2g_elevation_meters", {
    header: () => (
      <HeaderWithTooltip
        label="SF2G Elev"
        tooltip="Total elevation gain from SF2G commute rides only"
      />
    ),
    cell: (info) => {
      return <span>{info.getValue()}</span>;
  ...
  columnHelper.accessor("last_ride_date", {
    header: () => (
      <HeaderWithTooltip
        label="Last SF2G"
        tooltip="Date of most recent SF2G commute ride (excludes non-SF2G rides)"
      />
    ),
    cell: (info) => {
...
export function getLeaderboardColumns(
    ...
    if (id === "sf2g_total" && includeOther) {
      return {
        ...
        cell: (info: {
          ...
          const row = info.row.original;
          const adjustedTotal =
            safeNumber(row.sf2g_total) + safeNumber(row.other_count);
          return (
            <button
              className="leaderboard__count-btn leaderboard__total"
              onClick={(e) => {
  ...
  return columns.filter((col) => {
    ...
    if (density === "condensed" && !CONDENSED_COLUMN_IDS.has(colId ?? ""))
      return false;
    return true;
  });
}
